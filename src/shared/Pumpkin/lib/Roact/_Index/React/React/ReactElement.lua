...
-- Pumpkin support
local PumpkinMetatable

local exports = {}
exports.__set_pumpkin_mt = function(mt)
	PumpkinMetatable = mt
end
-- ROBLOX deviation END
...
local function ReactElement<P, T>(
	...
	if not PumpkinMetatable then
		error("Pumpkin hasn't been required yet")
	end

	setmetatable(element, PumpkinMetatable)
